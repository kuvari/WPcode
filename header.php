...
<body>
	...
	<!--メインビュー-->
	<section class="p-main-view">
		<div class="p-main-view__inner">
			<!--mv画像-->
			<div class="p-main-view__images">
				<div class="p-main-view__img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/main-mv1.jpg" alt=""></div>
				<div class="p-main-view__img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/main-mv2.jpg" alt=""></div>
				<div class="p-main-view__img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/common/main-mv3.jpg" alt=""></div>
			</div>
			<!--mvタイトル-->
			<div class="p-main-view__block">
				<h2 class="p-main-view__title">メインタイトルが入ります</h2>
				<p class="p-main-view__subtitle">サブタイトルが入ります</p>
			</div>
		</div>
	</section>
